...
# load MCMC data file
file1       = np.loadtxt(filePath1+'MCMC_ParabolicModel_meerKATLBandmeerKATLBand_0.001.dat')
file2       = np.loadtxt(filePath1+'MCMC_ParabolicModel_meerKATUHFBandmeerKATUHFBand_0.001.dat')
file3       = np.loadtxt(filePath1+'MCMC_ParabolicModel_skaOIMBand1skaOIMBand1_0.001.dat')
...
# saving as pdf
g.export(f'{filePath}MCMCcontourNewPlotsParabolicModel.pdf')
#--------------------------------------------------------------------------------------------------------------------------