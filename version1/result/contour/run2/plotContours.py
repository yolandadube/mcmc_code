...
# load MCMC data file
file1       = np.loadtxt(filePath+'MCMC_skaOIMBand1skaOIMBand1_kfg0_001h.dat')
file2       = np.loadtxt(filePath+'MCMC_skaOIMBand1skaOIMBand1_kfg0_005h.dat')
file3       = np.loadtxt(filePath+'MCMC_skaOIMBand1skaOIMBand1_kfg0_01h.dat')
...
linestyles = ['-', '-', '-']
labelS     = [r'$k_\mathrm{fg}=0.001\,h\,\mathrm{Mpc}^{-1}$', \
			  r'$k_\mathrm{fg}=0.005\,h\,\mathrm{Mpc}^{-1}$', \
			  r'$k_\mathrm{fg}=0.01\,h\,\mathrm{Mpc}^{-1}$']
...
# saving as pdf
g.export(f'{filePath}MCMCcontour1.pdf')
#--------------------------------------------------------------------------------------------------------------------------