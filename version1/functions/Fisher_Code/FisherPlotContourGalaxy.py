...
def plot_contours_galaxy(mainPath, dictionary):
	...
	data1 = np.loadtxt(Path+"cov_matrix_desiBGS.dat")
	data2 = np.loadtxt(Path+"cov_matrix_desiELG.dat")
	data3 = np.loadtxt(Path+"cov_matrix_HAlpha.dat")
	#--------------------------------------------------------------------------------------------------------------------------
	...
	cases      = [samplesMC1, samplesMC3, samplesMC2]
	colors     = [sns.xkcd_rgb["purple"], sns.xkcd_rgb["green"], sns.xkcd_rgb["orange"]]
	linestyles = ['-', '-', '-']
	labelS     = [r'DESI BGS', r'Euclid', r'DESI ELG']
	...
	# saving as pdf
	g.export(Path+'FisherContourGalaxy.pdf')
