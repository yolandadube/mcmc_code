...
int transfer_init(
  ...
  */
  ...
  /* "Window function": look for a better definition */
  double * window_1;
  double * window_2;
...
#pragma omp flush(abort)
  ...
  /** free the arrays created dinamically */
  free(ptr->selection_mean);
  free(ptr->selection_width);
  if (ppt->has_nc_density)
    free(ptr->selection_bias);
  if (ppt->has_nc_rsd || ppt->has_nc_lens || ppt->has_nc_gr)
    free(ptr->selection_magnification_bias);
...
int transfer_free(
  ...
  if (ptr->has_cls == _TRUE_) {
    ...
    if (ptr->nz_evo_size_1 > 0) {
      free(ptr->nz_evo_z_1);
      free(ptr->nz_evo_nz_1);
      free(ptr->nz_evo_dlog_nz_1);
      free(ptr->nz_evo_dd_dlog_nz_1);
    }
    
    if (ptr->nz_evo_size_2 > 0) {
      free(ptr->nz_evo_z_2);
      free(ptr->nz_evo_nz_2);
      free(ptr->nz_evo_dlog_nz_2);
...
int transfer_indices_of_transfers(
  ...
  if (ppt->has_scalars == _TRUE_) {
    ...
    class_define_index(ptr->index_tt_density,ppt->has_nc_density,              index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_rsd,    ppt->has_nc_rsd,                  index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_d0,     ppt->has_nc_rsd,                  index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_d1,     ppt->has_nc_rsd,                  index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_nc_lens,ppt->has_nc_lens,                 index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_nc_g1,  ppt->has_nc_gr,                   index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_nc_g2,  ppt->has_nc_gr,                   index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_nc_g3,  ppt->has_nc_gr,                   index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_nc_g4,  ppt->has_nc_gr,                   index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_nc_g5,  ppt->has_nc_gr,                   index_tt,ptr->selection_num*ptr->selection_tracers_number);
    class_define_index(ptr->index_tt_lensing,ppt->has_cl_lensing_potential,    index_tt,ptr->selection_num*ptr->selection_tracers_number);
  ...
  for (index_md=0; index_md < ppt->md_size; index_md++) {
    ...
    for (index_tt=0;index_tt<ptr->tt_size[index_md];index_tt++) {
      ...
      if (_scalars_) {
        ...
        if ((_index_tt_in_range_(ptr->index_tt_density, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_density)) ||
            (_index_tt_in_range_(ptr->index_tt_rsd,     ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd)) ||
            (_index_tt_in_range_(ptr->index_tt_d0,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd)) ||
            (_index_tt_in_range_(ptr->index_tt_d1,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd)) ||
            (_index_tt_in_range_(ptr->index_tt_nc_lens, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_lens))||
            (_index_tt_in_range_(ptr->index_tt_nc_g1,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))  ||
            (_index_tt_in_range_(ptr->index_tt_nc_g2,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))  ||
            (_index_tt_in_range_(ptr->index_tt_nc_g3,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))  ||
            (_index_tt_in_range_(ptr->index_tt_nc_g4,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))  ||
            (_index_tt_in_range_(ptr->index_tt_nc_g5,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))
            )
          l_max=ppt->l_lss_max;

        if ((ppt->has_cl_lensing_potential == _TRUE_) && (index_tt >= ptr->index_tt_lensing) && (index_tt < ptr->index_tt_lensing+ptr->selection_num*ptr->selection_tracers_number))
          l_max=ppt->l_lss_max;
  ...
  for (index_md = 0; index_md < ptr->md_size; index_md++) {
    ...
    for (index_tt=0; index_tt<ptr->tt_size[index_md]; index_tt++) {
      ...
      if (_scalars_) {
        ...
        if (_index_tt_in_range_(ptr->index_tt_rsd,     ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_theta_m;

        if (_index_tt_in_range_(ptr->index_tt_d0,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_theta_m;

        if (_index_tt_in_range_(ptr->index_tt_d1,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_theta_m;

        if (_index_tt_in_range_(ptr->index_tt_nc_lens, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_lens))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_phi_plus_psi;

        if (_index_tt_in_range_(ptr->index_tt_nc_g1,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_psi;

        if (_index_tt_in_range_(ptr->index_tt_nc_g2,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_phi;

        if (_index_tt_in_range_(ptr->index_tt_nc_g3,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_phi_prime;

        if (_index_tt_in_range_(ptr->index_tt_nc_g4,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_phi_plus_psi;

        if (_index_tt_in_range_(ptr->index_tt_nc_g5,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_phi_plus_psi;
...
int transfer_source_tau_size(
  ...
  /** In this function it is not necessary to differentiate between different tracers,
   *  since they share the same redshift bins. However in future versions of Multi_CLASS, 
    ...
    if (_nonintegrated_ncl_) {
      ...
      /* other cases (gaussian, top-hat...) */
        ...
        *tau_size = (int)ppr->selection_sampling;
        ...
        l_limber=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[bin];
      ...
      *tau_size = (int)ppr->selection_sampling;
      ...
      if(_index_tt_in_range_(ptr->index_tt_nc_g5,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr)) {
        ...
        *tau_size=MAX(*tau_size,(int)((tau0-tau_min)/((tau0-tau_mean)/2./MIN(l_limber,ppt->l_lss_max)))*ppr->selection_sampling_bessel);
        ...
        l_limber=ppr->l_switch_limber_for_nc_los_over_z*ptr->selection_mean[bin];
        /* check that bessel well sampled, if not define finer sampling
           overwriting the previous one.
           One Bessel oscillations corresponds to [Delta tau]=2pi/k.
           This is minimal for largest relevant k_max,
...
int transfer_sources(
  ...
  /* tracer for computation of cl_density */
  int tracer = 0;
  ...
  /* array used only for non-Gaussian constribution */
  double * selection;
  ...
  if (redefine_source == _TRUE_) {
    ...
    if (_scalars_) {
      ...
      if (_nonintegrated_ncl_) {
        ...
        _get_bin_nonintegrated_ncl_(index_tt)
        _get_tracer_nonintegrated_ncl_(index_tt)

        /* redefine the time sampling, no need for tracer information so far */
        ...
        for (index_tau = 0; index_tau < tau_size; index_tau++) {
          ...
          */
          ...
          /* Tracer information needed only here, other changes are exclusively k-dependent. */
          if (tracer == 0) 
			rescaling = window_1[index_tt*tau_size_max+index_tau];
		  else 
			rescaling = window_2[index_tt*tau_size_max+index_tau];
			
		  /** Compute the non-Gaussian correction to the bias. */
		  if (_index_tt_in_range_(ptr->index_tt_density, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_density)) {
			  rescaling -= 2.0 * ptr->f_NL * pow(ptr->k[index_md][index_q]/ptr->k_pivot_NG, ptr->n_NG)
					       * (ptr->selection_bias[tracer*ptr->selection_num+bin]-1.0) * ptr->delta_crit * 2.0/3.0
					       * (5.0*pba->Omega0_m/2.0/(pow(pba->Omega0_m, 4.0/7.0)-pba->Omega0_lambda+(1.0+pba->Omega0_m/2.0)*(1.0+pba->Omega0_lambda/70.0)))
					       * selection[index_tau] / sources[index_tau];	
		  }
      ...
      if (_integrated_ncl_) {
        ...
        _get_bin_integrated_ncl_(index_tt)
        _get_tracer_integrated_ncl_(index_tt)
        ...
        for (index_tau = 0; index_tau < tau_size; index_tau++) {
          ...
          */
          ...
          /* copy from input array to output array */
          if (tracer == 0)
            sources[index_tau] *= window_1[index_tt*tau_size_max+index_tau];
          else 
            sources[index_tau] *= window_2[index_tt*tau_size_max+index_tau];
...
int transfer_selection_function(
  ...
  if (ptr->selection_window == tophat) {
    ...
    *selection = (1.-tanh((x-ptr->selection_width[bin])/(ppr->selection_tophat_edge*ptr->selection_width[bin])))/2.;
    //*selection =(0.5/tanh(ptr->selection_width[bin]/(2.0*ppr->selection_tophat_edge)))*( tanh((x+ptr->selection_width[bin])/ppr->selection_tophat_edge) - tanh((x-ptr->selection_width[bin])/ppr->selection_tophat_edge) ) 
...
int transfer_dNdz_analytic(
  ...
  if (tracer == 0) {
	...
	else if (ptr->selection_tracer_1 == spherex_galaxy) {
	  z0 = 0.53;
      alpha = 1.1;
      beta = 1.5;
	...
	else if (ptr->selection_tracer_2 == spherex_galaxy) {
	  z0 = 0.53;
      alpha = 1.1;
      beta = 1.5;
	...
	else if (ptr->selection_tracer_2 == astrophysical_gws) {
	  z0 = 2.55;
      alpha = 1.3;
      beta = 2.0;
  ...
  if (q>q_max_bessel) {
    *use_limber = _TRUE_;
    ...
    if (_scalars_) {
      ...
      if (_index_tt_in_range_(ptr->index_tt_density, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_density) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_density)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_rsd,     ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_rsd)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_d0,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_d0)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_d1,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_d1)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_lens, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_lens) && (l>=ppr->l_switch_limber_for_nc_los_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_nc_lens)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g1, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_nc_g1)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g2, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_nc_g2)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g3, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_nc_g3)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g4, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_los_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_nc_g4)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_nc_g5, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr) && (l>=ppr->l_switch_limber_for_nc_local_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_nc_g5)%ptr->selection_num])) {
        if (ptr->selection_window != dirac) *use_limber = _TRUE_;
      }
      if (_index_tt_in_range_(ptr->index_tt_lensing, ptr->selection_num*ptr->selection_tracers_number, ppt->has_cl_lensing_potential) && (l>=ppr->l_switch_limber_for_nc_los_over_z*ptr->selection_mean[(index_tt-ptr->index_tt_lensing)%ptr->selection_num])) {
        *use_limber = _TRUE_;
      }
    }
  }
...
int transfer_global_selection_read(
  ...
  if (ptr->has_nz_file == _TRUE_) {
    ...
    input_file = fopen(ptr->nz_file_name_1,"r");
    class_test(input_file == NULL,
               ptr->error_message,
               "Could not open file %s!",ptr->nz_file_name_1);
    ...
    class_alloc(ptr->nz_z_1,sizeof(double)*ptr->nz_size_1,ptr->error_message);
    class_alloc(ptr->nz_nz_1,sizeof(double)*ptr->nz_size_1,ptr->error_message);
    class_alloc(ptr->nz_ddnz_1,sizeof(double)*ptr->nz_size_1,ptr->error_message);

    for (row=0; row<ptr->nz_size_1; row++){
      status = fscanf(input_file,"%lf %lf",
                      &ptr->nz_z_1[row],&ptr->nz_nz_1[row]);
      //printf("%d: (z,dNdz) = (%g,%g)\n",row,ptr->nz_z[row],ptr->nz_nz[row]);
    }
    fclose(input_file);

    /* Call spline interpolation: */
    class_call(array_spline_table_lines(ptr->nz_z_1,
                                        ptr->nz_size_1,
                                        ptr->nz_nz_1,
                                        1,
                                        ptr->nz_ddnz_1,
    ...
    if (ptr->selection_multitracing == _TRUE_) {
	  input_file = fopen(ptr->nz_file_name_2,"r");
      class_test(input_file == NULL,
                 ptr->error_message,
                 "Could not open file %s!",ptr->nz_file_name_2);
      ...
      /* Allocate room for interpolation table */
      class_alloc(ptr->nz_z_2,sizeof(double)*ptr->nz_size_2,ptr->error_message);
      class_alloc(ptr->nz_nz_2,sizeof(double)*ptr->nz_size_2,ptr->error_message);
      class_alloc(ptr->nz_ddnz_2,sizeof(double)*ptr->nz_size_2,ptr->error_message);
      
      for (row=0; row<ptr->nz_size_2; row++){
        status = fscanf(input_file,"%lf %lf",
                        &ptr->nz_z_2[row],&ptr->nz_nz_2[row]);
        //printf("%d: (z,dNdz) = (%g,%g)\n",row,ptr->nz_z[row],ptr->nz_nz[row]);
      }
      fclose(input_file);
      
      /* Call spline interpolation: */
      class_call(array_spline_table_lines(ptr->nz_z_2,
                                          ptr->nz_size_2,
                                          ptr->nz_nz_2,
                                          1,
                                          ptr->nz_ddnz_2,
  ...
  if (ptr->has_nz_evo_file == _TRUE_) {
    ...
    input_file = fopen(ptr->nz_evo_file_name_1,"r");
    class_test(input_file == NULL,
               ptr->error_message,
               "Could not open file %s!",ptr->nz_evo_file_name_1);
    ...
    rewind(input_file);
    ptr->nz_evo_size_1 = row-1;

    /* Allocate room for interpolation table */
    class_alloc(ptr->nz_evo_z_1,sizeof(double)*ptr->nz_evo_size_1,ptr->error_message);
    class_alloc(ptr->nz_evo_nz_1,sizeof(double)*ptr->nz_evo_size_1,ptr->error_message);
    class_alloc(ptr->nz_evo_dlog_nz_1,sizeof(double)*ptr->nz_evo_size_1,ptr->error_message);
    class_alloc(ptr->nz_evo_dd_dlog_nz_1,sizeof(double)*ptr->nz_evo_size_1,ptr->error_message);

    for (row=0; row<ptr->nz_evo_size_1; row++){
      status = fscanf(input_file,"%lf %lf",
                      &ptr->nz_evo_z_1[row],&ptr->nz_evo_nz_1[row]);
    }
    fclose(input_file);

    /* infer dlog(dN/dz)/dz from dN/dz */
    ptr->nz_evo_dlog_nz_1[0] =
      (log(ptr->nz_evo_nz_1[1])-log(ptr->nz_evo_nz_1[0]))
      /(ptr->nz_evo_z_1[1]-ptr->nz_evo_z_1[0]);
    for (row=1; row<ptr->nz_evo_size_1-1; row++){
      ptr->nz_evo_dlog_nz_1[row] =
        (log(ptr->nz_evo_nz_1[row+1])-log(ptr->nz_evo_nz_1[row-1]))
        /(ptr->nz_evo_z_1[row+1]-ptr->nz_evo_z_1[row-1]);
    }
    ptr->nz_evo_dlog_nz_1[ptr->nz_evo_size_1-1] =
      (log(ptr->nz_evo_nz_1[ptr->nz_evo_size_1-1])-log(ptr->nz_evo_nz_1[ptr->nz_evo_size_1-2]))
      /(ptr->nz_evo_z_1[ptr->nz_evo_size_1-1]-ptr->nz_evo_z_1[ptr->nz_evo_size_1-2]);
    ...
    */
    ...
    /* Call spline interpolation: */
    class_call(array_spline_table_lines(ptr->nz_evo_z_1,
                                        ptr->nz_evo_size_1,
                                        ptr->nz_evo_dlog_nz_1,
                                        1,
                                        ptr->nz_evo_dd_dlog_nz_1,
                                        _SPLINE_EST_DERIV_,
                                        ptr->error_message),
               ptr->error_message,
               ptr->error_message);
    ...
    if (ptr->selection_multitracing == _TRUE_) {
	  input_file = fopen(ptr->nz_evo_file_name_2,"r");
      class_test(input_file == NULL,
                 ptr->error_message,
                 "Could not open file %s!",ptr->nz_evo_file_name_2);
      ...
      rewind(input_file);
      ptr->nz_evo_size_2 = row-1;
      
      /* Allocate room for interpolation table */
      class_alloc(ptr->nz_evo_z_2,sizeof(double)*ptr->nz_evo_size_2,ptr->error_message);
      class_alloc(ptr->nz_evo_nz_2,sizeof(double)*ptr->nz_evo_size_2,ptr->error_message);
      class_alloc(ptr->nz_evo_dlog_nz_2,sizeof(double)*ptr->nz_evo_size_2,ptr->error_message);
      class_alloc(ptr->nz_evo_dd_dlog_nz_2,sizeof(double)*ptr->nz_evo_size_2,ptr->error_message);
      
      for (row=0; row<ptr->nz_evo_size_2; row++){
        status = fscanf(input_file,"%lf %lf",
                        &ptr->nz_evo_z_2[row],&ptr->nz_evo_nz_2[row]);
      }
      fclose(input_file);
      
      /* infer dlog(dN/dz)/dz from dN/dz */
      ptr->nz_evo_dlog_nz_2[0] =
        (log(ptr->nz_evo_nz_2[1])-log(ptr->nz_evo_nz_2[0]))
        /(ptr->nz_evo_z_2[1]-ptr->nz_evo_z_2[0]);
      for (row=1; row<ptr->nz_evo_size_2-1; row++){
        ptr->nz_evo_dlog_nz_2[row] =
          (log(ptr->nz_evo_nz_2[row+1])-log(ptr->nz_evo_nz_2[row-1]))
          /(ptr->nz_evo_z_2[row+1]-ptr->nz_evo_z_2[row-1]);
      }
      ptr->nz_evo_dlog_nz_2[ptr->nz_evo_size_2-1] =
        (log(ptr->nz_evo_nz_2[ptr->nz_evo_size_2-1])-log(ptr->nz_evo_nz_2[ptr->nz_evo_size_2-2]))
        /(ptr->nz_evo_z_2[ptr->nz_evo_size_2-1]-ptr->nz_evo_z_2[ptr->nz_evo_size_2-2]);
      
      /* Call spline interpolation: */
      class_call(array_spline_table_lines(ptr->nz_evo_z_2,
                                          ptr->nz_evo_size_2,
                                          ptr->nz_evo_dlog_nz_2,
                                          1,
                                          ptr->nz_evo_dd_dlog_nz_2,
                                          _SPLINE_EST_DERIV_,
                                          ptr->error_message),
                 ptr->error_message,
                 ptr->error_message);
 ...
 * @param tracer				Input: tracer you want to compute the window of
...
int transfer_precompute_selection(
                     ...
                     double tau_rec,
                     int tau_size_max,
                     double ** window_1, /* Pass a pointer to the pointer, so the pointer can be allocated inside of the function */
                     double ** window_2
                     ){
  /** Summary: */
  ...
  class_alloc((*window_1),tau_size_max*ptr->tt_size[index_md]*sizeof(double),ptr->error_message);
  class_alloc((*window_2),tau_size_max*ptr->tt_size[index_md]*sizeof(double),ptr->error_message);
  class_alloc(pvecback,pba->bg_size*sizeof(double),ptr->error_message);
    ...
    if (_nonintegrated_ncl_) {
      ...
      for (index_tau = 0; index_tau < tau_size; index_tau++) {
        ...
        */
        ...
        if (_index_tt_in_range_(ptr->index_tt_density, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_density))
          rescaling = ptr->selection_bias[tracer*ptr->selection_num+bin] * selection[index_tau];
        ...
        if (_index_tt_in_range_(ptr->index_tt_d1,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))
          ...
          rescaling = selection[index_tau]*(1.
                                            ...
                                            /pvecback[pba->index_bg_H]
                                            +(2.-5.*ptr->selection_magnification_bias[tracer*ptr->selection_num+bin])
                                            // /tau0_minus_tau[index_tau] // in flat space
                                            *cotKgen_source  // in general case
                                            /pvecback[pba->index_bg_a]
                                            /pvecback[pba->index_bg_H]
                                            +5.*ptr->selection_magnification_bias[tracer*ptr->selection_num+bin]
                                            -f_evo
                                            );
        ...
        if (tracer == 0) {
          (*window_1)[index_tt*tau_size_max+index_tau] = rescaling;
	    }
	    else {
        ...
        if (index_tau == tau_size-1) {
          ...
          for (index_tau_sources=0;
            ...
            if ((tau0_minus_tau_lensing_sources[index_tau_sources] > 0.) && (tau0_minus_tau_lensing_sources[index_tau_sources]-tau0_minus_tau[index_tau] > 0.)) {
              ...
              if (_index_tt_in_range_(ptr->index_tt_lensing, ptr->selection_num*ptr->selection_tracers_number, ppt->has_cl_lensing_potential)) {
              ...
              if (_index_tt_in_range_(ptr->index_tt_nc_lens, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_lens)) {
                ...
                rescaling -=
                  (2.-5.*ptr->selection_magnification_bias[tracer*ptr->selection_num+bin])/2.
                  //  *(tau0_minus_tau[index_tau]-tau0_minus_tau_lensing_sources[index_tau_sources])
                  //  /tau0_minus_tau[index_tau]
                  //  /tau0_minus_tau_lensing_sources[index_tau_sources]
                  *sinKgen_source_to_lens
...
int transfer_f_evo(
  ...
  if ((ptr->has_nz_evo_file == _TRUE_) || (ptr->has_nz_evo_analytic == _TRUE_)){
    ...
    if (ptr->has_nz_evo_file ==_TRUE_) {
      ...
      if (tracer == 0) {
         class_test((z<ptr->nz_evo_z_1[0]) || (z>ptr->nz_evo_z_1[ptr->nz_evo_size_1-1]),
                   ptr->error_message,
        ...
        class_test((z<ptr->nz_evo_z_2[0]) || (z>ptr->nz_evo_z_2[ptr->nz_evo_size_2-1]),
                   ...
                   "Your input file for the selection function only covers the redshift range [%f : %f]. However, your input for the selection function requires z=%f",
                   ptr->nz_evo_z_2[0],
                   ptr->nz_evo_z_2[ptr->nz_evo_size_2-1],
                   z);
        class_call(array_interpolate_spline(
                                            ptr->nz_evo_z_2,
                                            ptr->nz_evo_size_2,
